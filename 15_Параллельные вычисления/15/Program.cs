...
class Program
{
    ...
    static List<int> FindPrimaryNumbers(int start, int end) // алгоритм Эратосфена для поиска простых чисел
    {
    ...
    static void ContinuationTasks()//выводит результат задачи, как только она завершится.
    {
    ...
    static void ParallelLoops() //Сравнение времени выполнения циклjd
    {
    ...
    static void BlockingCollectionDemo() // для синхронной работы нескольких поставщиков и покупателей
    {
    ...
    static async Task AsyncAwaitDemo() //Асинхронная операция выполняется с помощью async и await
    {
